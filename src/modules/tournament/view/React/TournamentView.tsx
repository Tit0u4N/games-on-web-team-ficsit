      ...
      <div className={'w-2/3 flex flex-col gap-4'}>
        ...
        <div className={'flex h-full gap-4'}>
          ...
          <div className={'w-1/3 flex flex-col gap-4'}>
            <div className={'flex size-full border border-default-200 rounded-2xl'}>
              Boom
            </div>
            <div className={'flex h-auto w-full border border-default-200 rounded-2xl'}>
              <DiceComponent className={"w-full p-2 flex items-center justify-around"} dicePresenter={tournament.dicePresenter}
                             onRoll3DStart={() => {
                               setHideModal(true);
                             }}
                             onRoll3DEnd={() => {
