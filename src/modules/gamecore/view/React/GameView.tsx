  ...
  const speechTexts = config.narratorBox.speechText;
    ...
    return (
        <div>
            ...
            {!showSpeechBox && !showTutorialSpeech && !removebackdrop &&  (
                <SpeechBox>
                    <SimpleMessageSpeechBox message={"Now we will introduce you to the controls."}
                                            onComplete={() => setShowTutorialSpeech(true)}/>
                </SpeechBox>
            )}
            {showTutorialSpeech && (
                <SpeechBox>
                    <TutorialSpeech onComplete={handleTutorialComplete}
