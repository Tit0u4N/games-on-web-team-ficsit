...
export class BuildingPresenter implements ViewInitable {
    ...
    private _hasArenaShownNarratorBox: boolean = false;
    ...
    set hasArenaShownNarratorBox(value: boolean) {
        this._hasArenaShownNarratorBox = value;
    }

    get hasArenaShownNarratorBox(): boolean {
        return this._hasArenaShownNarratorBox;
    }
}
