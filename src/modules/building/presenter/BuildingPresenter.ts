...
export class BuildingPresenter implements ViewInitable {
  ...
  private _hasTrainingCenterShownNarratorBox: boolean = false;
  private _hasArenaPreviewShownNarratorBox: boolean = false;
  ...
  constructor(
    ...
    this.buildingFactory = new BuildingFactory(this, mapPresenter);
  ...
  get hasTrainingCenterShownNarratorBox(): boolean {
    return this._hasTrainingCenterShownNarratorBox;
  }

  get hasArenaPreviewShownNarratorBox(): boolean {
    return this._hasArenaPreviewShownNarratorBox;
  }

  set hasArenaPreviewShownNarratorBox(value: boolean) {
    this._hasArenaPreviewShownNarratorBox = value;
  }
}
